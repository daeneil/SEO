  ...
  return (
    <div className="w-full px-4 md:w-1/2 lg:w-1/4">
      <div className="wow fadeInUp group mb-12" data-wow-delay=".15s">
        <div className="relative z-10 mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-yellow-500">
        ...
        <Link
          href={btnLink}
          className="text-base font-medium text-yellow-500 hover:text-yellow-600 dark:text-yellow-500 dark:hover:text-yellow-400"
        >
          {btn}
        </Link>
      </div>
